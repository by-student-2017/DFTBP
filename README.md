...
- When I compared the output files of DFTB+ and Lammps at 0 K, I confirmed that the pressure values are almost the same for DFTB+ and Lammps when converted to the same unit. I confirmed that the forces are also approximately the same value.
