...
- The second term of pressure (lammps) is changed in "virial" of "fix_dftp.cpp". The original DFTBP is used as a reference, but the comments in dftbplus.h indicate that both the DFTB+ formula is Pascal, which I am not satisfied with. I would like to get information from many people regarding this as well.
