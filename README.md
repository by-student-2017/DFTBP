...
## My Wish ######################################
- The only people who have published the code that links "DFTB+" and "Lammps" are the developers (ORNL and LANL) and myself (RIKEN), who has made it work with the latest version. We strongly look forward to the success of the Max Planck Institute and other motivated individuals.
